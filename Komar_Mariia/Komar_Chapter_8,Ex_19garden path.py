...
question1=('Question:')
print question1
question=(' Read up on Уgarden pathФ sentences. How might the computational work of a parser relate to the difficulty humans have with processing these sentences? (See http://en.wikipedia.org/wiki/Garden_path_sentence.)')
print question
answer1=('Answer:')
print answer1
...
#€к ≥ дл€ людини, так ≥ дл€ комютера. 
#Ќаприклад  УThe old man the boat.Ф це може означати,
#що "старий чолов≥к ... човен", табто реченн€ некоректне тому що без д≥Їслова,
