...
print nltk.classify.accuracy(classifier, test_set)#I get the basic accuracy
#If the word is not on the most frequent words list but its hypernims are in the list then:
#add this word to the most frequent words list
...
#Quantity of words added to the list 
