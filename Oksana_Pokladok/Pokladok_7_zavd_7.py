...
test_sents = conll2000.chunked_sents('test.txt'[:100], chunk_types=['NP']) # Evaluate the work of a chunker on the basis of 100 sentences from corpus Conll 2000                                                                            #the basis of 100 sentences of corpus Conll2000 
print cp.evaluate(test_sents)
sentence='The big plane took off the ground'
