...
#Вивівши результати,можна зробити висновок,що слова go та went мають морфологічні відмінності,тому вони не можуть вільно змінюватися залежно від контексту.Так як кожна з цих форм залежить від граматичного контексту речення.
