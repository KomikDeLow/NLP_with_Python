...
train_set, test_set=featuresets[40:], featuresets[:40]# Stvorjuju nabory danyh dlya navchannya i testuvannya
classifier=nltk.NaiveBayesClassifier.train(train_set)# Trenuju klasyfikator
print nltk.classify.accuracy(classifier, test_set) # Ocinka tochnosti klasyfikatora
for word in all_review_words.keys()[:450]: #zbil'shuju chastotu hipernimiv
...
print nltk.classify.accuracy(classifier, dev_set) #vyvedennya chastotu
