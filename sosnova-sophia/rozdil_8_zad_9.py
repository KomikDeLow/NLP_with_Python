...
# If we parse the sentences that has more than 20 words in length using the
# grammar shown in Example 8-1, we end up with two or more trees.
# Since this grammar licenses two or more trees for these sentences,
# the sentences are structurally ambiguous.	
