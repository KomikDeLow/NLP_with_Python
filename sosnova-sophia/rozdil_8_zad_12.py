...
# but then it is not needed to since this is fully determined by whether W2 is empty or not.
# In a real implementation, but it might well be convenient or efficient to add a simple flag
