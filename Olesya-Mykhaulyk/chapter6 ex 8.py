...
random.shuffle(documents)# Shuffle the sequence
...
#Getting a basic accuracy
#if this word isn't in the list of the most frequent words, but its hypernym is than the program adds it in the list
...
#counting words added to the list
