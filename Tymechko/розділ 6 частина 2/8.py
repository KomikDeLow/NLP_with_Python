...
def document_features(document):
    ...
    for word in word_features:
        features['contains($s)' % word] = (word in set(document))
    return features
...
#Як бачимо, базова точність аналізатора складає 75%. Після того, як я добавив
#слова, які не входять в список найчастотніших, проте їхні гіперніми входять,
#то точність аналізатора зросла до 80%. Кількість таких слів склала 38.
