...
#Chapter 6, Task 5
#Our research showed that result of productivity from entropy taking to consideration results. 
#using entropy we can have better results, as is uses search techniques to find a set of parameters that will maximize the performance of the classifier.
import nltk 
