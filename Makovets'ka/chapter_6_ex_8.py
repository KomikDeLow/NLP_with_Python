...
#document classifier presented in this chapter
#to use features that generalize the
#words that appear in a document, making it more
#likely that they will match words
