## Obriza Khrystyna , AL-11, Chapter 6, Task 5.The task was to select one of the classification, I have chosen gender detection,
##using the same training and test data to build classificators and to compare the productivity of that classifiers
import nltk ##import all necessary functions
