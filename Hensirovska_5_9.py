...
nltk.pos_tag(sent1)
#Hensirovska_Khrystyna.Коли я виконала токенізацію першого
#речення,то програма визначила,що слово GO  в реченні Go away!
#належить до частини мови іменник.Це непавильне визначення
#частини мови,бо слово GO є дієсловом.
sent2=nltk.word_tokenize("We went on the excursion.")
nltk.pos_tag(sent2)
#Виконавши токенізацію другого речення,отримуємо результат,що
#слово went є дієсловом минулого часу.
