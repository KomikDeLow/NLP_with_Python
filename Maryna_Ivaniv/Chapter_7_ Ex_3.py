#Maryna Ivaniv PRLs-11 Chapter 7, Ex.3
...
grammar = "NP: {<DT>?<JJ>*<NN>}" # create ragular expression# create a chunk parser
cp = nltk.RegexpParser(grammar)# test chunk parser on my sentence
