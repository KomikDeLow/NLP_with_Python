# Khrystyna Maschkaevich, AL-13, Chapter 9, Task 4
# The task was to modify the grammar, to incorporate a BAR feature
# for dealing with phrasal projections
import nltk
...
for tree in parser.nbest_parse(tokens):
	print tree
print tree
#This module contains the modified grammar with BAR feature which deals
	#with phrasal projections.

# There are cases when some hprases have no heads but we would like our grammar
# to express parent/head-child relation where it holds. We need to find the way
# to relate those relation. X-BAR adresses this issue by abstracting out of phrasal
#levels
