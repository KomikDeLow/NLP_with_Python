##Khrystyna Maschakhevich, AL-13, Chapter 9,Task 8

import nltk
## Enter the feature structures
...
## Check the results of feature structures unifications with the help of nltk
...
## These two feature structures will not be unified
