...
#Create the trivial chunk parser that creates no chunks
...
# test chunk_parser on our sentence.The result is a tree,which we can print
print chunk_parser.parse(sentence)
# once more create a chunk parser
chunk_parser = nltk.RegexpParser(grammar)
# we are interested in the PP chunks right now.  
