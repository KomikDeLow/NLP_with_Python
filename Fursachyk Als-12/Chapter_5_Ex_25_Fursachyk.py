# Chapter_5_Ex_25_Fursachyk
import nltk
from nltk.corpus import *
# trenuju unigram tagger na dejakyh tekstah 
...
print unigram_tagger.evaluate(test_sentsENG)#resul'tat
0.8110236220472441
...
print unigram_tagger.evaluate(test_sents)#resul'tat
0.70929705215419503 
