...
print 'fsA subsumes main_fs: ',fsA.subsumes(main_fs)# cheking if the builded Structures subsume the main structure
print 'fsB subsumes main_fs: ', fsB.subsumes(main_fs)
