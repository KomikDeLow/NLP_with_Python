#Iryna Ros, PRLs-11, capter 5, exersise 27
#
#We inspected the confusion matrix for the bigram tagger t2 defined in Section 5.5, and
#identified one or more sets of tags to collapse. Also we defined a dictionary to do the mapping,
#and evaluated the tagger on the simplified data.
#
import nltk
