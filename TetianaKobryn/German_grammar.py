...
Or such presentation of this task is ok?
"""
...
#Chapter 9 Ex.11
#Extend the German grammar in Example 9-4 so that it can handle so-called
#verbsecond structures like the following: Heute sieht der Hund die Katze.
